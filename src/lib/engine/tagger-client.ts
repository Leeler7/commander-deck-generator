 ...
 * parent always subsumes it: a bounce / spot-removal card is removal, a mana-dork / mana-rock is
 * ramp, a counterspell is protection, and so on. Add a new subcategory tag here and it counts toward
 * its parent everywhere at once. (Counterspell lives under protection, not removal — see the
...
const ROLE_MEMBER_TAGS: Record<RoleKey, string[]> = {
  ...
  boardwipe: ['boardwipe'],
  cardDraw: ['card-advantage', 'tutor', 'draw', 'wheel', 'looting', 'cantrip'],
